...
By compounding the results of each iteration, and gathering feedback as fast as possible, iterative approach makes it possible to achieve good results when we're facing a [wicked problem](../../0080-thinking/030-wicked-problems.md).
