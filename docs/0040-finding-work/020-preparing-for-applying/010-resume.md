...
I recommend using LaTeX for writing your resume. It's easy to use, and it's compatible with most ATS systems. You can use [jankapunkt/latexcv](https://github.com/jankapunkt/latexcv) template to get started.
