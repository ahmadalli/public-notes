...
- Maccy
- Karabiner-Elements
- [SwiftDefaultApps](https://github.com/Lord-Kamina/SwiftDefaultApps): To set the default apps for the file extensions
...
- To use dd/mm/yyyy format for dates, run `defaults write -app "Microsoft Excel" AppleLocale en_NL`
  You can use the following command to list all the available locales:
  ```bash
  swift -e "import Foundation; print(NSLocale.availableLocaleIdentifiers.sorted().joined(separator: \"\\n\"))"
  ```
