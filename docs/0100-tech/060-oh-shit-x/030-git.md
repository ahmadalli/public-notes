...
While they're under the same question, [this solution](https://stackoverflow.com/a/68536044/1003464) **doesn't work** because `subtree` isn't suitable for this use-case and the copied commits won't have the proper directory structure in the remote repository and will corrupt the history.
