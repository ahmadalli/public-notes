...
- [Calendar Builder](https://calendar-builder.jumbled.dev): I wanted to create and print a custom calendar for a friend. I built this (well, Gemini did most of the building) to create calendars with custom images and styles.
